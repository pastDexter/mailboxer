module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, sanitize_text=true, attachment=nil, message_timestamp = Time.now, send_message=true)
        ...
        message.deliver false, sanitize_text, send_message
      end

      #Basic reply method. USE NOT RECOMENDED.
      #Use reply_to_sender, reply_to_all and reply_to_conversation instead.
      def reply(conversation, recipients, reply_body, subject=nil, sanitize_text=true, attachment=nil, send_message=true)
        ...
        response.deliver true, sanitize_text, send_message
      end
      ...
      def reply_to_conversation(conversation, reply_body, subject=nil, should_untrash=true, sanitize_text=true, attachment=nil, send_message=true)
        ...
        reply(conversation, conversation.last_message.recipients, reply_body, subject, sanitize_text, attachment, send_message)
      end
